...
listing = dir('./Anchor1/copyFromPi5/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal1{count} = importdata(['./Anchor1/copyFromPi5/Footstep/' listing(i).name]);
    end
end

listing = dir('./Anchor2/copyFromPi5/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal2{count} = importdata(['./Anchor2/copyFromPi5/Footstep/' listing(i).name]);
    end
end

listing = dir('./Anchor3/copyFromPi5/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal3{count} = importdata(['./Anchor3/copyFromPi5/Footstep/' listing(i).name]);
    end
end

listing = dir('./Anchor4/copyFromPi5/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal4{count} = importdata(['./Anchor4/copyFromPi5/Footstep/' listing(i).name]);
    end
end
...
% s4 = s4(3000000:end);
% 
% s1 = s1(1000000:2000000);
% s2 = s2(1000000:2000000);
% s3 = s3(1000000:2000000);
% s4 = s4(1000000:2000000);
