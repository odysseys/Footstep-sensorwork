...
%% load data
listing = dir('../Anchor1/copyFromPi10/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal1{count} = importdata(['../Anchor1/copyFromPi10/Footstep/' listing(i).name]);
    end
end

listing = dir('../Anchor2/copyFromPi10/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal2{count} = importdata(['../Anchor2/copyFromPi10/Footstep/' listing(i).name]);
    end
end

listing = dir('../Anchor3/copyFromPi10/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal3{count} = importdata(['../Anchor3/copyFromPi10/Footstep/' listing(i).name]);
    end
end

listing = dir('../Anchor4/copyFromPi10/Footstep/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal4{count} = importdata(['../Anchor4/copyFromPi10/Footstep/' listing(i).name]);
    end
end
...
% 
% 
locTime{1} = [4.656*10^18, 4.666*10^18];
locTime{2} = [4.696*10^18, 4.704*10^18];
locTime{3} = [4.786*10^18, 4.796*10^18];
locTime{4} = [4.867*10^18, 4.874*10^18];
locTime{5} = [4.958*10^18, 4.966*10^18];
locTime{6} = [5.02*10^18, 5.03*10^18];
locTime{7} = [5.085*10^18, 5.092*10^18];
locTime{8} = [5.168*10^18, 5.178*10^18];
locTime{9} = [5.344*10^18, 5.35*10^18];
locTime{10} = [5.453*10^18, 5.46*10^18];
locTime{11} = [5.559*10^18, 5.565*10^18];
locTime{12} = [5.67*10^18, 5.677*10^18];
locTime{13} = [5.753*10^18, 5.758*10^18];
locTime{14} = [5.822*10^18, 5.83*10^18];
locTime{15} = [5.915*10^18, 5.921*10^18];
locTime{16} = [5.99*10^18, 5.996*10^18];
locTime{17} = [6.099*10^18, 6.106*10^18];
locTime{18} = [6.161*10^18, 6.167*10^18];
locTime{19} = [6.36*10^18, 6.365*10^18];
locTime{20} = [6.52*10^18, 6.526*10^18];
locTime{21} = [6.7*10^18, 6.706*10^18];
locTime{22} = [6.829*10^18, 6.835*10^18];


energyRatio = zeros(22,4);
