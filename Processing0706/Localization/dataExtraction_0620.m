...
listing = dir('../Anchor1/copyFromPi7_5h/16/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal1{count} = importdata(['../Anchor1/copyFromPi7_5h/16/' listing(i).name]);
    end
end

listing = dir('../Anchor2/copyFromPi7_5h/16/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal2{count} = importdata(['../Anchor2/copyFromPi7_5h/16/' listing(i).name]);
    end
end

listing = dir('../Anchor3/copyFromPi7_5h/16/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal3{count} = importdata(['../Anchor3/copyFromPi7_5h/16/' listing(i).name]);
    end
end

listing = dir('../Anchor4/copyFromPi7_5h/16/');
count = 0;
for i = 1 : length(listing)
    if sum(ismember(listing(i).name,'txtout')) == 9
        count = count + 1;
        signal4{count} = importdata(['../Anchor4/copyFromPi7_5h/16/' listing(i).name]);
    end
end
...
figure;
plot(s1I(find(s1I>8.27*10^18 & s1I<8.31*10^18)), s1S(find(s1I>8.27*10^18 & s1I<8.31*10^18)));hold on;
plot(s2I(find(s2I>8.27*10^18 & s2I<8.31*10^18)), s2S(find(s2I>8.27*10^18 & s2I<8.31*10^18)));hold on;
plot(s3I(find(s3I>8.27*10^18 & s3I<8.31*10^18)), s3S(find(s3I>8.27*10^18 & s3I<8.31*10^18)));hold on;
plot(s4I(find(s4I>8.27*10^18 & s4I<8.31*10^18)), s4S(find(s4I>8.27*10^18 & s4I<8.31*10^18)));hold off;
ylim([-700,700]);
